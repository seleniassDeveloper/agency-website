...
function Blob() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.set(meshRef.current.position, { x: 1.8, y: 0 })
      ...
      tl1.to(meshRef.current.position, { x: 0, y: -0.5, duration: 1, ease: "sine.inOut" }, 0)
         .to(meshRef.current.scale, { x: 12, y: 12, z: 12, duration: 1, ease: "sine.in" }, 0)
         .to(proxy, { distort: 0.8, speed: 4, duration: 1, ease: "sine.in", onUpdate: () => updateMaterial(proxy) }, 0)
         .to(meshRef.current.scale, { x: 1.5, y: 1.5, z: 1.5, duration: 1, ease: "sine.out" }, 1)
         .to(proxy, { distort: 0.4, speed: 1.5, duration: 1, ease: "sine.out", onUpdate: () => updateMaterial(proxy) }, 1)
      ...
      tl2.to(meshRef.current.position, { x: -1.8, y: 0, duration: 1, ease: "sine.inOut" }, 0)
         .to(meshRef.current.scale, { x: 12, y: 12, z: 12, duration: 1, ease: "sine.in" }, 0)
         .to(proxy, { distort: 0.8, speed: 4, duration: 1, ease: "sine.in", onUpdate: () => updateMaterial(proxy) }, 0)
         .to(meshRef.current.scale, { x: 1.5, y: 1.5, z: 1.5, duration: 1, ease: "sine.out" }, 1)
         .to(proxy, { distort: 0.4, speed: 1.5, duration: 1, ease: "sine.out", onUpdate: () => updateMaterial(proxy) }, 1)
      ...
      tl3.to(meshRef.current.position, { x: 1.5, y: -0.5, duration: 1, ease: "sine.inOut" }, 0)
         .to(meshRef.current.scale, { x: 12, y: 12, z: 12, duration: 1, ease: "sine.in" }, 0)
         .to(proxy, { distort: 0.8, speed: 4, duration: 1, ease: "sine.in", onUpdate: () => updateMaterial(proxy) }, 0)
         .to(meshRef.current.scale, { x: 1.5, y: 1.5, z: 1.5, duration: 1, ease: "sine.out" }, 1)
         .to(proxy, { distort: 0.4, speed: 1.5, duration: 1, ease: "sine.out", onUpdate: () => updateMaterial(proxy) }, 1)
      ...
      tl4.to(meshRef.current.position, { x: 0, y: -1, duration: 1, ease: "sine.inOut" }, 0)
         .to(meshRef.current.scale, { x: 12, y: 12, z: 12, duration: 1, ease: "sine.in" }, 0)
         .to(proxy, { distort: 0.8, speed: 4, duration: 1, ease: "sine.in", onUpdate: () => updateMaterial(proxy) }, 0)
  ...
  useFrame((state) => {
    ...
    if (meshRef.current) {
      ...
      // Remove hardcoded position.y animation here so it doesn't fight GSAP
